...
parser.add_argument('scale', help='rescale', default=0.352778)
# All the SVG exported from Illustrator need this scaling value. Idk why
...
flatten(args.scale, args.in_dir, 'bottomsilk.svg', args.out_dir, "B_Silkscreen.gbr")
